package eu.solven.holymolap.bytes;
...
public final class JmhSerialisationPerf {
	private static final Logger LOGGER = LoggerFactory.getLogger(JmhSerialisationPerf.class);
...
class ObjectToBeSerialised implements Serializable {
	...
	public ObjectToBeSerialised(final long sourceId,
