...
import eu.solven.holymolap.measures.operator.IStandardDoubleOperators;
import eu.solven.pepper.memory.IPepperMemoryConstants;

public class TestMutableDoubleAggregatesColumn {
	@Test
	public void testWriteNeutral() {
		MutableDoubleAggregatesColumn column = new MutableDoubleAggregatesColumn(IStandardDoubleOperators.SUM);
